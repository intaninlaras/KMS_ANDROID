...
public class MateriTersimpanFragment extends Fragment {
    private MateriTersimpanViewModel materiViewModel;
    private RecyclerView recyclerView;
    private MateriAdapter materiAdapter;

    public static MateriTersimpanFragment newInstance() {
        return new MateriTersimpanFragment();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_materi_tersimpan, container, false);
    }
